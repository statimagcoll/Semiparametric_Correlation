...
RidgeCV <- function(data, folds, outcome, typeDat){
  ...
  for(i in 1:folds){
    ...
    # Assigning x and y 
    if(outcome == "age"){
      x_var = data.matrix(train[, grepl(typeDat, colnames(train))]) # can add euler here
      y_var = data.matrix(train[, outcome])
      newx = data.matrix(test[, grepl(typeDat, colnames(test))])
    }
    
    else{
      x_var = data.matrix(train[, grepl(typeDat, colnames(train))])
      y_var = data.matrix(train[, outcome])
      newx = data.matrix(test[, grepl(typeDat, colnames(test))])
    }
...
corr_results <- ggplot(results, aes(x = label, y = estimates, color = stat)) +
  ...
  labs(title = "Ridge Regression Analysis of Outcomes in RBC No Covariates",
       x = "Model Features",
       y = "Correlation",
       color = "Estimator") +
  theme_bw() + 
...
ggsave("/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_100.png",
       plot = corr_results,
       width = 9,  # make wider
...
saveRDS(corr_results, file = "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_100.rds")
```
...
diff_results <- ggplot(results, aes(x = Type, y = diff)) +
  ...
  geom_errorbar(aes(ymin = lCI_diff, ymax = uCI_diff),
                ...
                position = position_dodge(width = 0.5)) +
  facet_wrap(~ ScoreType, nrow = 1) +  # or facet_grid(~ ScoreType)
  labs(title = "Ridge Regression One-Step Differences in RBC No Covariates",
       x = "Comparisons",
       y = "Difference") +
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 45, hjust=1)) + 
...
# Saving to square dimensions
ggsave("/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_diff_100.png",
       plot = diff_results,
       width = 9,  # make wider
       height = 4,  # adjust height
       dpi = 300)
...
# Saving ggplot object itself
saveRDS(diff_results, file = "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_diff_100.rds")
```
...
ratio_results <- ggplot(results, aes(x = Type, y = ratio)) +
  ...
  geom_errorbar(aes(ymin = lCI_ratio, ymax = uCI_ratio),
                ...
                position = position_dodge(width = 0.5)) +
  facet_wrap(~ ScoreType, nrow = 1) +  # or facet_grid(~ ScoreType)
  labs(title = "Ridge Regression One-Step Ratios in RBC No Covariates",
       x = "Comparisons",
       y = "Ratio") +
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 45, hjust=1)) + 
...
# Saving to square dimensions
ggsave("/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_ratio_100.png",
       plot = ratio_results,
       width = 9,  # make wider
       height = 4,  # adjust height
       dpi = 300)
...
# Saving ggplot object itself
saveRDS(ratio_results, file = "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_results_ratio_100.rds")
```
...
# Saving tables
save_kable(ext_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Externalizing_Table_100.html")
save_kable(int_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Internalizing_Table_100.html")
save_kable(age_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Age_Table_100.html")
save_kable(pfac_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_PFactor_Table_100.html")
```
...
# Saving tables
save_kable(ext_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Externalizing_DR_Table_100.html")
save_kable(int_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Internalizing_DR_Table_100.html")
save_kable(age_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_Age_DR_Table_100.html")
save_kable(pfac_kable, "/media/disk2/multivariateBWAS/ishaan_bwas/noCov_RR_PFactor_DR_Table_100.html")
```
