...
ggsave("Fig1.pdf", p, width = 12, height = 8, device = cairo_pdf)
```
...
p = plot_panel_mult_full(c("ridge_age", "rf_age"), dt_labels = c("Ridge", "Random Forest"), type = "pq", cf = "inst", source_name = "ML Model:")

p

# save for journal submission
ggsave("Fig2.pdf", p, width = 22, height = 14, device = cairo_pdf)
```
...
p = plot_panel_mult_full(c("FC_7_rf", "FC_17_rf"), dt_labels = c("7 network (p=28)", "17 network (p=153)"), source_name = "Data Dimensionality:")

p

# save for journal submission
ggsave("Fig3.pdf", p, width = 22, height = 14, device = cairo_pdf)
```
...
p = plot_panel_mult_full(c("FC_7_ridge", "FC_17_ridge"), dt_labels = c("7 network (p=28)", "17 network (p=153)"), source_name = "Data Dimensionality:")

p

# save for journal submission
ggsave("FigS4.pdf", p, width = 22, height = 14, device = cairo_pdf)
```
...
p = plot_panel_mult_full(c("DKT_pfactor", "schaefer_pfactor"), dt_labels = c("DKT", "Schaefer 300"), type = "pq", cf = "inst", source_name = "Atlas:")

p 

# save for journal submission
ggsave("FigS5.pdf", p, width = 22, height = 14, device = cairo_pdf)
```
